...
class PermissionManager(private val context: Context) {
    fun snapshot(): List<CapabilityStatus> = buildList {
        ...
        add(CapabilityStatus("Overlay", if (Settings.canDrawOverlays(context)) CapabilityState.READY else CapabilityState.OPTIONAL, "Allows the floating JARVIS bubble over other apps."))
