...
import com.jarvis.assistant.ui.screens.dashboard.DashboardScreen
...
private val destinations = listOf(
    Destination("home", "Center", Icons.Filled.Home),
    Destination("chat", "Command", Icons.Filled.Chat),
    Destination("memory", "Memory", Icons.Filled.Psychology),
    Destination("history", "Log", Icons.Filled.History),
    Destination("settings", "Control", Icons.Filled.Settings)
)
